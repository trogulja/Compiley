...
/*!*******************************************************!*\
  !*** ./node_modules/update-electron-app/package.json ***!
  \*******************************************************/
/*! exports provided: name, version, description, repository, main, types, license, dependencies, devDependencies, scripts, standard, jest, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"name\":\"update-electron-app\",\"version\":\"1.5.0\",\"description\":\"A drop-in module that adds autoUpdating capabilities to Electron apps\",\"repository\":\"https://github.com/electron/update-electron-app\",\"main\":\"index.js\",\"types\":\"index.d.ts\",\"license\":\"MIT\",\"dependencies\":{\"electron-is-dev\":\"^0.3.0\",\"github-url-to-object\":\"^4.0.4\",\"is-url\":\"^1.2.4\",\"ms\":\"^2.1.1\"},\"devDependencies\":{\"jest\":\"^22.4.3\",\"semantic-release\":\"^15.13.12\",\"standard\":\"^11.0.1\",\"standard-markdown\":\"^5.0.1\",\"travis-deploy-once\":\"^4.4.1\",\"tslint\":\"^5.10.0\",\"typescript\":\"^2.8.3\"},\"scripts\":{\"test\":\"jest && standard --fix && npm run lint && standard-markdown\",\"lint\":\"tslint -c tslint.json index.d.ts\",\"watch\":\"jest --watch --notify --notifyMode=change --coverage\",\"travis-deploy-once\":\"travis-deploy-once\",\"semantic-release\":\"semantic-release\"},\"standard\":{\"env\":{\"jest\":true}},\"jest\":{\"testURL\":\"http://localhost\"}}");
...
var environment = 'production'; // let environment = 'development';
// Handle creating/removing shortcuts on Windows when installing/uninstalling.

if (__webpack_require__(/*! electron-squirrel-startup */ "./node_modules/electron-squirrel-startup/index.js")) app.quit(); // Set autoupdate functionality

__webpack_require__(/*! update-electron-app */ "./node_modules/update-electron-app/index.js")(); // Auto SET ENV - when deployed, paths change somewhat


if (process.execPath.search('electron.exe') !== -1) environment = 'development';
if (environment === 'development') __webpack_require__(/*! dotenv */ "./node_modules/dotenv/lib/main.js").config();
...
var createWindow = function createWindow() {
  ...
  var allowResize = true; // Create the browser window.
  ...
  mainWindow = new BrowserWindow({
    ...
    icon: ( false ? undefined : "E:\\code\\Apps\\Compiley\\.webpack\\main") + '/native_modules/lamp.ico'
  });
  ...
  Menu.setApplicationMenu(mainMenu); // Open the DevTools.
  // mainWindow.webContents.openDevTools();
  // Dynamic window type, based on package.json

  mainWindow.webContents.on('did-finish-load', function () {
    var name = __webpack_require__(/*! ../package.json */ "./package.json").productName;

    var version = __webpack_require__(/*! ../package.json */ "./package.json").version;

    var windowtitle = name + " app v" + version;
    mainWindow.setTitle(windowtitle);
  }); // Testing autoupdater

  autoUpdater.on('checking-for-update', function () {
    mainWindow.webContents.send('log', "[".concat(new Date().toTimeString().split(' ')[0], "] Checking for update..."));
  });
  autoUpdater.on('before-quit-for-update', function () {
    mainWindow.webContents.send('log', "[".concat(new Date().toTimeString().split(' ')[0], "] Updating...")); // controller.destroy();
...
module.exports = __webpack_require__(/*! E:\code\Apps\Compiley\src\main.js */"./src/main.js");
